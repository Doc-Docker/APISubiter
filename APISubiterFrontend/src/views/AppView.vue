                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <router-link class="dropdown-item" to="/cadastroServicoInstalacao">Serviço de
                                        instalação</router-link>
                                </li>
                                <li>
                                    <router-link class="dropdown-item" to="/cadastroServicoManutencao">Serviço de
                                        manutenção</router-link>
                                </li>
                                <li>
                                    <hr class="dropdown-divider" />
                                </li>
                                <li>
                                    <router-link class="dropdown-item" to="#/cadastroEquipamentos">Equipamentos
                                    </router-link></li>
                                <li>
                                    <hr class="dropdown-divider" />
                                </li>
