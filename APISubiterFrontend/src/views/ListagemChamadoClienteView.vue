  ...
  <div class="table">
    <div class="mb-3 mt-3">
      ...
      <table class="table table-striped table-bordered" style="text-align: center">
        <thead>
          <tr>
            <th scope="col-md-6">Nome Usuário</th>
            <th scope="col-md-6">Tipo de Chamado</th>
            <th scope="col-md-6">Criticidade</th>
            <th scope="col-md-6">Data de Chamado</th>
            <th scope="col-md-6">Descrição</th>
            <th scope="col-md-6">Situação Chamado</th>
            <th scope="col-md-6">Solução</th>
            <th scope="col-md-6">Data Encerramento</th>
        ...
        <tbody>
          <tr v-for="(chamado_cliente, i) in chamado_clientes" :key="i">
            ...
            <td>
              ...
              <b-button v-b-modal.modal-1>Editar Chamado</b-button>
